...
import { searchRecipes, getRandomRecipes, saveRecipe, getSavedRecipes } from '../utils/api';
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    fetchRandomRecipes();
    // Get user's saved recipes to check against
    fetchSavedRecipes();
  }, []);
    ...
    <div className="dashboard">
      ...
      <div className="recipes-container">
        ...
        {loading && recipes.length === 0 ? (
          ...
          <>
            {recipes.length === 0 ? (
              <div className="no-recipes">No recipes found. Try different search criteria.</div>
            ) : (
            ...
            {searchPerformed && pagination.offset + pagination.number < pagination.totalResults && (
